...
public class WaitlistDbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase){
        ...
        final String SQL_CREATE_WAITLIST_TABLE= "CREATE TABLE"+ WaitlistContract.WaitlistEntry.TABLE_NAME + "(" +
                ...
                WaitlistEntry.COLUMN_GUEST_NAME + "INSERIRE TESTO,"+
                WaitlistEntry.COLUMN_PARTY_SIZE + "INSERIRE VALORE" +
                WaitlistEntry.COLUMN_TIMESTAMP + "TIMESTAMP DEFAULT CURRENT DEFAULT_TMESTAMP" + ")";
